...
def agent(obs):
    ...
    def choose_hand_action(
        ...
        if hand_position in hand_optional_water_targets:
            return ["WATER"]
        ...
        elif hand_optional_water_targets:
            target = nearest_position(hand_position, hand_optional_water_targets)
        else:
            return ["PASS"]
    ...
    for crop in CROPS_MANAGED:
        ...
        if obs["day"] == 0 and crop in ("CARROT", "WHEAT"):
            target_seed_count = 0
        ...
        if (
            ...
            combined_early_strawberry_target = (
                (EARLY_NE_STRAWBERRY_TARGET if early_ne_strawberry_phase_active else 0)
                + (EARLY_NW_STRAWBERRY_TARGET if early_nw_strawberry_phase_active else 0)
            )
