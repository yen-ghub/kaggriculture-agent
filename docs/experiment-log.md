...
Hand planting v1 allows both hired hands to plant from the shared seed inventory while reserving seeds between the farmer and hands. Across the eight reported five-seed matchups, it won all 80 matches with zero errors. Against Two hands v1, average money increased to 23058.0 and average harvests increased to 79.8, confirming that hand planting adds production capacity rather than merely redistributing the farmer's work.
